...
public class eHO_TC_010 extends BaseTest{
		...
		@Test
		public void TC_010Test()
		{
			try
			{
				test=rep.startTest("TC_010Test");
				...
				agentPolicyDetailPage.selectDirectiveOutcome("Allow");
				agentPolicyDetailPage.setPolicyDescription("Agent Domain specified , operator Not Equals, allow Policy");
				agentPolicyDetailPage.clickDomainAll();
				agentPolicyDetailPage.clickExcludeListAgent();
				...
				actualMessage= driver.findElement(By.xpath(".//*[@id='policiesResult:j_id_6j:0:j_id_6l']")).getText();
				 expectedMessage="Agent Domain specified , operator Not Equals, allow Policy";			
				 softAssert.assertEquals(expectedMessage, actualMessage);
				...
				System.out.println("Passed TC _010");
			}
			catch(Exception ex)
			{
