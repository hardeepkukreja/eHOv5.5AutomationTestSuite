...
public class eHO_TC_009 extends BaseTest{
		...
		@Test
		public void TC_009Test()
		{
			try
			{
				test=rep.startTest("TC_009Test");
				...
				agentPolicyDetailPage.setPolicyDescription("Agent Domain specified , operator Not Equals, deny Policy");
				
				agentPolicyDetailPage.clickDomainAll();
				// include and exclude 
				agentPolicyDetailPage.clickIncludeListAgent();
				...
				actualMessage= driver.findElement(By.xpath(".//*[@id='policiesResult:j_id_6j:0:j_id_6l']")).getText();
				 expectedMessage="Agent Domain specified , operator Not Equals, deny Policy";			
				 softAssert.assertEquals(expectedMessage, actualMessage);
				...
				System.out.println("Passed TC _009");
			}
			catch(Exception ex)
			{
