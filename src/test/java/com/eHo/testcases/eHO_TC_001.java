...
//This test case is verifying the basic flow of creating a record level Deny policy where Record Level is set to equal 
//and domain is set to specific and operator is equals
public class eHO_TC_001 extends BaseTest{
	...
	public void TC_001Test()
	{
		...
		recordLevelPolicyDetailPage.selectDirectiveOutcome("Deny"); // fix 
		...
		System.out.println("Passed TC _001");
