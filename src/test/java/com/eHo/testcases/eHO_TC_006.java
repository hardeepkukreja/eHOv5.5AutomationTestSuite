...
public class eHO_TC_006 extends BaseTest{
		...
		@Test
		public void TC_006Test()
		{
			try
			{
				test=rep.startTest("TC_006Test");
				...
				agentPolicyDetailPage.setPolicyDescription("Agent Domain specified , operator Equals, Allow Policy");
				...
				actualMessage= driver.findElement(By.xpath(".//*[@id='policiesResult:j_id_6j:0:j_id_6l']")).getText();
				 expectedMessage="Agent Domain specified , operator Equals, Allow Policy";			
				 softAssert.assertEquals(expectedMessage, actualMessage);
				...
				System.out.println("Passed TC _006");
