...
public class eHO_TC_012 extends BaseTest{
		...
		@Test
		public void TC_012Test()
		{
			try
			{
				test=rep.startTest("TC_012Test");
				...
				//agentPolicyDetailPage.selectDomainEqualNotEqual("NotEqual");
				...
				System.out.println("Passed TC _012");
			}
			catch(Exception ex)
			{
