...
//Scenario 4: A record level ‘allow policy with domain specific, operator not equals will be created 
public class eHO_TC_004 extends BaseTest{
	...
	@Test
	public void TC_004Test()
	{
		try
		{
		test=rep.startTest("TC_004Test");
		...
		recordLevelPolicyDetailPage.setPolicyDescription("Record level Domain specific,Operator Not equals, Allow");
		...
		// test 
		 ...
		 expectedMessage="Record level Domain specific,Operator Not equals, Allow";			
		 softAssert.assertEquals(expectedMessage, actualMessage);
		...
		System.out.println("Passed TC _004");
